...
<head>
    ...
    <title>Forgot Password - Pro Vision Academy</title>
            ...
            <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-700">
                        ...
                        <p>Enter your email address and we'll send you a link to reset your password. Check your spam folder if you don't receive the email within a few minutes.</p>
                    </div>
                </div>
            </div>
        </div>
